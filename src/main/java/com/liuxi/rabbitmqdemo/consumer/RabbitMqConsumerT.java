 ...
 */
@Component
public class RabbitMqConsumerT {

    private static Logger logger = LoggerFactory.getLogger(RabbitMqConsumerT.class);

    @RabbitListener(queues = "logistics_user_logout_queue")
